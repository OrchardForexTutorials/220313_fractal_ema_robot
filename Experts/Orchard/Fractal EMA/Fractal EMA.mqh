...
int      OnInit() {
   ...
   Expert = new CExpert( new CIndicatorMA( InpFastMAPeriod, MODE_EMA, PRICE_CLOSE ),
                              new CIndicatorMA( InpSlowMAPeriod, MODE_EMA, PRICE_CLOSE ),
                              new CIndicatorFractal(), InpTPSLRatio, InpVolume, InpTradeComment,
                              InpMagic //	Common
        );
