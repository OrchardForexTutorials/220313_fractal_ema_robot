...
public:
   CExpert( CIndicatorMA *fastMA, CIndicatorMA *slowMA, CIndicatorFractal *fractal, //
            double tpslRatio,                                                       //
...
//
CExpert::CExpert( CIndicatorMA *fastMA, CIndicatorMA *slowMA, CIndicatorFractal *fractal, //
                  double tpslRatio,                                                       //
                  double volume, string tradeComment, int magic )
...
void CExpert::MakeOrder( ENUM_ORDER_TYPE type, double price, double sl ) {
   ...
   Trade.OrderDelete( mSymbol, type ); //	Cancel any existing orders of the same type
